...
export default function Characters() {
    ...
    const mostrarData=async()=>{
       let infoAPI= await fetch("https://rickandmortyapi.com/api/character/?page=1")
         ...
         setDataCompleta([...dataCompleta,...infoAPI.results]);
         setData([...data,...infoAPI.results])
    ...
    return(
        ...
        <div class="container-filter p-4">  
            <h2 className='subt-1 t-h2'>Filters</h2>
        </div>

        <form className={show? 'form row gap-2':'row gap-2'}>
                <div class="c-form d-flex justify-content-between">
                    {
